                        ...
                        <div class="col-md-12">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <form action="http://<?php echo BASE_SERVER ; ?>/erp/pages/scripts/category/edit.php" method="POST" id="manage_category_validations">
                                                    <div class="form-body">
                            ...
                            <span class="required"> * </span>
                                                        ...
                                                        <div class="form-group clearfix">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" id="hsn_code" name="hsn_code" class="form-control" placeholder="HSN Code" /> </div>
                                                        </div>
                            ...
                            <span class="required"> * </span>
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" id="gst_rate" name="gst_rate" class="form-control" placeholder="GST Rate" /> </div>
                                                        </div>
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                       <form action="http://localhost/erp/pages/scripts/category/delete.php" method = "POST">
                                           <input type="text" id="recordID" name="category_id">
...
<![endif]-->
    ...
    <script src="../assets/pages/scripts/manage_category_validate.js"></script>
